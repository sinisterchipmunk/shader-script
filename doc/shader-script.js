(function(global) {
  ...
  grammar = {
    ...
    Expression: [o('Identifier'), o('Assign'), o('Call'), o('Literal'), o('TypeConstructor'), o('FunctionCall'), o('Operation'), o('Parenthetical'), o('Accessor')],
    Statement: [
      o('Return TERMINATOR'), o('FunctionDefinition'), o('Comment'), o('FunctionDeclaration TERMINATOR'), o('VariableDeclaration TERMINATOR'), o('StorageDeclaration TERMINATOR'), o('STATEMENT TERMINATOR', function() {
    ...
    Assign: [
      ...
      }), o('Accessor = Expression', function() {
        return new Assign($1, $3);
      })
    ],
    Accessor: [
