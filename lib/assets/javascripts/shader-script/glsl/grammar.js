(function() {
  ...
  grammar = {
    ...
    Expression: [o('Identifier'), o('Assign'), o('Call'), o('Literal'), o('TypeConstructor')],
    Statement: [
      o('Return'), o('Comment'), o('FunctionDefinition'), o('FunctionDeclaration'), o('VariableDeclaration'), o('STATEMENT', function() {
