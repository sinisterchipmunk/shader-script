(function() {
  ...
  grammar = {
    ...
    Statement: [
      o('Return'), o('Comment'), o('FunctionDefinition'), o('VariableDeclaration'), o('STATEMENT', function() {
    ...
    FunctionDefinition: [
      o('Identifier Identifier Arguments Block', function() {
        return new Function($1, $2, $3, $4);
      })
    ],
    Block: [
      o('{ }', function() {
    ...
    Arguments: [
      o('CALL_START CALL_END', function() {
        ...
        return $2;
      }), o('CALL_START ArgList OptComma )', function() {
        return $2;
      })
    ],
    Array: [
