...
grammar =
  ...
  VariableDeclaration: [
    o 'Identifier Identifier',                  -> new Variable $1, $2
  ]
  ...
  FunctionDefinition: [
    o 'Identifier Identifier Arguments Block', -> new Function($1, $2, $3, $4)
  ]
 ...
 # Function Parameters
  ...
  Arguments: [
    ...
    o 'CALL_START ArgList OptComma )',          -> $2
  ]
